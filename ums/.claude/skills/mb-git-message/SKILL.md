...
- If delegation proceeds, dispatch the delegated worker on the cheapest capable tier — this is summarization work (see [UMS_MEMORY_BANK_CONTRACT.md](../shared/UMS_MEMORY_BANK_CONTRACT.md), section "Dispatch Model Policy").

...
Doklad: doklad/now-block.md, "The block's two readers"
...
Doklad: doklad/now-block.md, "Why an unparseable timestamp is malformed"
...
Doklad: doklad/now-block.md, "What does not carry over from the baton"

...
|---|---|---|
| Kontrakt v2 | [shared/UMS_MEMORY_BANK_CONTRACT.md](UMS_MEMORY_BANK_CONTRACT.md) | MB_ROOT, proposal pár, Target-MB discovery, harvest, dispatch model policy, fail-closed |

...
- Write the validated design (spec) to the canonical artifact defined by the contract.
  - (User preference may request a compatibility pointer file, but the canonical artifact remains the source of truth.)

...
| [`ums/.claude/skills/shared/`](../ums/.claude/skills/shared/) | Normativní zdroj vrstvy: kontrakt v2.18, manifest, vendor pin, overlay fragmenty. |
...
Vrstva je v provozu (kontrakt v2.18, vendor pin upstream v6.3.0). Práce na této
